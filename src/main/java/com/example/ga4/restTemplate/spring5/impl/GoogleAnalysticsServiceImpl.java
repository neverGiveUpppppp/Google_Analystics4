package com.example.ga4.restTemplate.spring5.impl;

import com.example.ga4.restTemplate.spring5.GoogleAnalysticsService;
...
@Service("GoogleAnalysticsServiceImpl2")
